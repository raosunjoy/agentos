...
# Inherit from generic x86_64 configuration
...
PRODUCT_COPY_FILES += \
    device/agentos/generic/audio/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRODUCT_NAME=agentos_x86_64 \
    PRIVATE_BUILD_DESC="agentos_x86_64-userdebug 14 UP1A.231005.007 eng.$(USER).$(shell date +%Y%m%d.%H%M%S) test-keys"

BUILD_FINGERPRINT := AgentOS/agentos_x86_64/generic_x86_64:14/UP1A.231005.007/eng.$(USER).$(shell date +%Y%m%d.%H%M%S):userdebug/test-keys